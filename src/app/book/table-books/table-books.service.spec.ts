...
describe('TableBooksService', () => {
  ...
  it('should get both sets of books, should be greater than 0 and equal to each other', inject(
      ...
      (httpMock: HttpTestingController, service: TableBooksService) => {
        ...
        sub$ = service.getSets().subscribe(data => {
          // console.log(data)

          expect(data.set1.data[0].title).toEqual("Harry Potter and the Order of the Phoenix");
          expect(data.set1.data[1].title).toEqual("The Hunger Games");
          expect(data.set1.data[2].title).toEqual("The Book Thief");
  ...
  // xit('Both sets should be are greater than 0 and equal to each other', inject(
  //   [HttpTestingController, TableBooksService],
  //   (httpMock: HttpTestingController, service: TableBooksService) => {
